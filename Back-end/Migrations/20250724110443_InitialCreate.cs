        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MacroMode = table.Column<int>(type: "int", nullable: false),
                    ProteinRatio = table.Column<int>(type: "int", nullable: false),
                    CarbsRatio = table.Column<int>(type: "int", nullable: false),
                    FatRatio = table.Column<int>(type: "int", nullable: false),
                    ProteinKcal = table.Column<int>(type: "int", nullable: false),
                    CarbsKcal = table.Column<int>(type: "int", nullable: false),
                    FatKcal = table.Column<int>(type: "int", nullable: false),
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IncludeTef = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MealOfTheDay = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyTarget = table.Column<double>(type: "float", nullable: true),
                    HasMaxThreshold = table.Column<bool>(type: "bit", nullable: false),
                    MaxThreshold = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNutrientTargets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserNutrientTargets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNutrientTargets_UserId",
